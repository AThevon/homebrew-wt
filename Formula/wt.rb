...
class Wt < Formula
  ...
  url "https://github.com/AThevon/wt/archive/refs/tags/v1.2.2.tar.gz"
  sha256 "a5a5bb7ef3dc7dca9b1e80ac4b044d06bbfcf0cb5061fd3804005094ef04c7c8"
  license "MIT"
  ...
  test do
    assert_match "wt 1.2.2", shell_output("#{bin}/wt-core --version 2>&1")
  end
end
