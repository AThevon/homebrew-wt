...
class Wt < Formula
  ...
  url "https://github.com/AThevon/wt/archive/refs/tags/v1.10.4.tar.gz"
  sha256 "dc956a85bc0a3b797dfd2a065ed69767b7e2bc08ab4df3a1d50eedaec2e9e7d9"
  license "MIT"
  ...
  test do
    assert_match "wt 1.10.4", shell_output("#{bin}/wt-core --version 2>&1")
  end
end
