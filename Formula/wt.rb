...
class Wt < Formula
  ...
  url "https://github.com/AThevon/wt/archive/refs/tags/v1.1.6.tar.gz"
  sha256 "bdbd0e2b5e40e5e6073b5003305e0f46773be5653f7627243a4e590926ee525e"
  license "MIT"
  ...
  test do
    assert_match "wt 1.1.6", shell_output("#{bin}/wt-core --version 2>&1")
  end
end
