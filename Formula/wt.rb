...
class Wt < Formula
  ...
  url "https://github.com/AThevon/wt/archive/refs/tags/v1.1.9.tar.gz"
  sha256 "98a3000ec4c924918756381e0a8716ef02215845d93065a58e1f9b74cf497042"
  license "MIT"
  ...
  test do
    assert_match "wt 1.1.9", shell_output("#{bin}/wt-core --version 2>&1")
  end
end
