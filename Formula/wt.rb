...
class Wt < Formula
  ...
  url "https://github.com/AThevon/wt/archive/refs/tags/v1.6.0.tar.gz"
  sha256 "ac1a277ad8dd9008c1fd3a4b154c4d5efd3f87cac6498cffd861f4aae38b004c"
  license "MIT"
  ...
  test do
    assert_match "wt 1.6.0", shell_output("#{bin}/wt-core --version 2>&1")
  end
end
