...
class Wt < Formula
  ...
  url "https://github.com/AThevon/wt/archive/refs/tags/v2.0.0.tar.gz"
  sha256 "c348d25e5b83d95715cef71df9618072a0a829c51eebbd0c01cfe6af670ad486"
  license "MIT"
  ...
  test do
    assert_match "wt 2.0.0", shell_output("#{bin}/wt-core --version 2>&1")
  end
end
