...
class Wt < Formula
  ...
  url "https://github.com/AThevon/wt/archive/refs/tags/v1.3.0.tar.gz"
  sha256 "ffdf42577af3704917a601cdff9fc7386869f7ea818b0d7982597b4bb31acdb5"
  license "MIT"
  ...
  test do
    assert_match "wt 1.3.0", shell_output("#{bin}/wt-core --version 2>&1")
  end
end
