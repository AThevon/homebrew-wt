...
class Wt < Formula
  ...
  url "https://github.com/AThevon/wt/archive/refs/tags/v1.1.2.tar.gz"
  sha256 "4888b41a6332d72b39b4355f2ae8a5c47571e5a376ccbe5ab19d147347a71dfa"
  license "MIT"
  ...
  test do
    assert_match "wt 1.1.2", shell_output("#{bin}/wt-core --version 2>&1")
  end
end
