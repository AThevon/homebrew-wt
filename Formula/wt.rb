...
class Wt < Formula
  ...
  url "https://github.com/AThevon/wt/archive/refs/tags/v1.7.0.tar.gz"
  sha256 "33df3a8dc913c09e3911d708ec5fcc7b37baf2e80b5a469f7c19e8a9080df86d"
  license "MIT"
  ...
  test do
    assert_match "wt 1.7.0", shell_output("#{bin}/wt-core --version 2>&1")
  end
end
