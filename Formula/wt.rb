...
class Wt < Formula
  ...
  url "https://github.com/AThevon/wt/archive/refs/tags/v1.9.0.tar.gz"
  sha256 "58ec6dd306e5d7eed142ebea3fa103b8720f825439754f7ff4b273772e60c3ff"
  license "MIT"
  ...
  test do
    assert_match "wt 1.9.0", shell_output("#{bin}/wt-core --version 2>&1")
  end
end
